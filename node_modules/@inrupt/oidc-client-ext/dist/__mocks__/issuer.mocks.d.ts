...
export declare const mockFetch: (payload: string, statusCode: number) => import("jest-mock").Mock<Promise<Response>, [_url: URL | RequestInfo, _init?: RequestInit | undefined]>;
